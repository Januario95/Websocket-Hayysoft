...
class ManageJson:
    def __init__(self, band_mac=None):
        ...
        """
        if not band_mac:
            self.filename = 'C:/Users/User/Desktop/backup/Employment/Hayysoft Systems/WebSocket/media/raw_data.json'
        else:
            self.band_mac = band_mac
            self.filename = f'C:/Users/User/Desktop/backup/Employment/Hayysoft Systems/WebSocket/media/{self.band_mac}.json'
            if not os.path.exists(self.filename):
                os.system(f'type nul > C:/Users/User/Desktop/backup/Employment/Hayysoft Systems/WebSocket/media/{self.band_mac}.json')
